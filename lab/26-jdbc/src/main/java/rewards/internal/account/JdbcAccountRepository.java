...
public class JdbcAccountRepository implements AccountRepository {
	...
	/**
	 * Instance de AccountExtractor qu'on va donner au JdbcTemplate pour "mapper" le resultSet en Account
	 */
	...
	public Account findByCreditCard(String creditCardNumber) {
		...
		// on passe le accountExtractor qui a été instancié comme ResultSetExtractor, c'est sa méthode extractData() qui va être utilisée
	...
	// on déclare une classe qui implémente ResultSetExtractor
	private class AccountExtractor implements ResultSetExtractor<Account> {
		// et on surcharge sa méthode extractData qui va être utilisée par JdbcTemplate pour mapper les résultats de requête SQL
